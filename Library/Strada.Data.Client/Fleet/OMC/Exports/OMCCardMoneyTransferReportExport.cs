...
public static class OMCCardMoneyTransferReportExport
{
	...
	public static Task<(MemoryStream stream, string fileName)> ExportReport(IEnumerable<OMCCardMoneyTransferOverviewModel> transferData, ReportExportType exportType, DateOnly? dateRangeStart = null, DateOnly? dateRangeEnd = null, bool showAllColumns = true, bool showDeleted = false, CompanyModel company = null, LedgerModel ledger = null) =>
