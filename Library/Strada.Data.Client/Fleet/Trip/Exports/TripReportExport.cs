...
public static class TripReportExport
{
	...
	public static Task<(MemoryStream stream, string fileName)> ExportExpensesReport(IEnumerable<TripExpensesOverviewModel> expensesData, ReportExportType exportType, DateOnly? dateRangeStart = null, DateOnly? dateRangeEnd = null, bool showAllColumns = true, bool showDeleted = false, ExpenseTypeModel expenseType = null, CompanyModel company = null, OMCModel omc = null, VehicleModel vehicle = null, RouteOverviewModel route = null, DriverOverviewModel driver = null) =>
	...
	public static Task<(MemoryStream stream, string fileName)> ExportCardPaymentsReport(IEnumerable<TripCardPaymentsOverviewModel> paymentsData, ReportExportType exportType, DateOnly? dateRangeStart = null, DateOnly? dateRangeEnd = null, bool showAllColumns = true, bool showDeleted = false, OMCCardModel omcCard = null, CompanyModel company = null, OMCModel omc = null, VehicleModel vehicle = null, RouteOverviewModel route = null, DriverOverviewModel driver = null) =>
		Api.PostForFile(Helper.MakeRouteFromEndpointFunction(_endpoint, nameof(ExportCardPaymentsReport)),
