...
public static class VehicleDocumentRenewalReportExport
{
	...
	public static async Task<(MemoryStream stream, string fileName)> ExportReport(IEnumerable<VehicleDocumentRenewalOverviewModel> renewalData, ReportExportType exportType, bool showAllColumns = true, VehicleModel vehicle = null, VehicleDocumentTypeModel documentType = null) =>
