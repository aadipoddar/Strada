...
public static class TripReportExport
{
		...
		DriverOverviewModel driver = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(TripOverviewModel.PendingDays)] = new() { DisplayName = "Pending Days", Format = "0", Alignment = CellAlignment.Right, IncludeInTotal = false },
		...
		DriverOverviewModel driver = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(TripExpensesOverviewModel.TDSAmount)] = new() { DisplayName = "TDS Amt", Format = "#,##0.00", Alignment = CellAlignment.Right, IncludeInTotal = true },
			...
			[nameof(TripExpensesOverviewModel.PendingDays)] = new() { DisplayName = "Pending Days", Format = "0", Alignment = CellAlignment.Right, IncludeInTotal = false },
		...
		if (showAllColumns)
		{
			...
			[
				...
				nameof(TripExpensesOverviewModel.TDSAmount),
		...
		DriverOverviewModel driver = null)
	{
		var columnSettings = new Dictionary<string, ReportColumnSetting>
		{
			...
			[nameof(TripCardPaymentsOverviewModel.TDSAmount)] = new() { DisplayName = "TDS Amt", Format = "#,##0.00", Alignment = CellAlignment.Right, IncludeInTotal = true },
			...
			[nameof(TripCardPaymentsOverviewModel.PendingDays)] = new() { DisplayName = "Pending Days", Format = "0", Alignment = CellAlignment.Right, IncludeInTotal = false },
		...
		if (showAllColumns)
		{
			...
			[
				...
				nameof(TripCardPaymentsOverviewModel.TDSAmount),
