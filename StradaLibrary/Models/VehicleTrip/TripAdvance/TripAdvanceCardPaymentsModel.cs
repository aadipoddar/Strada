namespace StradaLibrary.Models.VehicleTrip.TripAdvance;

public class TripAdvanceCardPaymentsModel
{
...
public class TripAdvanceCardPaymentsCartModel
{
	public int OMCCardId { get; set; }
...
public class TripAdvanceCardPaymentsOverviewModel
{
	public int Id { get; set; }
	public int OMCCardId { get; set; }
	public string OMCCardNumber { get; set; }
