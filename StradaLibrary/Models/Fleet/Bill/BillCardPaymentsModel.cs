namespace StradaLibrary.Models.Fleet.Bill;

public class BillCardPaymentsModel
{
...
public class BillCardPaymentsCartModel
{
	public int OMCCardId { get; set; }
...
public class BillCardPaymentsOverviewModel
{
	public int Id { get; set; }
	public int OMCCardId { get; set; }
	public string OMCCardNumber { get; set; }
