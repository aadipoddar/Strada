...
public partial class TripLedgerPaymentsReport : IAsyncDisposable
{
	...
	private List<TripLedgerPaymentsOverviewModel> _transactionOverviews = [];
	private List<TripLedgerPaymentsOverviewModel> _allTransactionOverviews = [];
	...
	private SfGrid<TripLedgerPaymentsOverviewModel> _sfGrid;
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			_allTransactionOverviews = await CommonData.LoadTableDataByDate<TripLedgerPaymentsOverviewModel>(
				FleetNames.TripLedgerPaymentsOverview,
	...
	private async Task OnMenuSelected(Syncfusion.Blazor.Navigations.MenuEventArgs<Syncfusion.Blazor.Navigations.MenuItem> args)
	{
		switch (args.Item.Id)
		{
			case "NewTransaction": await AuthenticationService.NavigateToRoute(PageRouteNames.Trip, FormFactor, JSRuntime, NavigationManager); break;
	...
	private async Task OnGridContextMenuItemClicked(ContextMenuClickEventArgs<TripLedgerPaymentsOverviewModel> args)
	{
		switch (args.Item.Id)
		{
