...
public partial class VehicleTripPaymentsReport : IAsyncDisposable
{
	...
	private List<VehicleTripCardPaymentsOverviewModel> _transactionOverviews = [];

	private SfGrid<VehicleTripCardPaymentsOverviewModel> _sfGrid;
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			_transactionOverviews = await CommonData.LoadTableDataByDate<VehicleTripCardPaymentsOverviewModel>(
				FleetNames.VehicleTripCardPaymentsOverview,
	...
	private async Task OnGridContextMenuItemClicked(ContextMenuClickEventArgs<VehicleTripCardPaymentsOverviewModel> args)
	{
		switch (args.Item.Id)
		{
			case "View":
