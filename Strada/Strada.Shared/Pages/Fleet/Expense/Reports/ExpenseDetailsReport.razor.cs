...
public partial class ExpenseDetailsReport : IAsyncDisposable
{
	...
	private List<ExpenseDetailsOverviewModel> _allTransactionOverviews = [];
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			_allTransactionOverviews = await CommonData.LoadTableDataByDate<ExpenseDetailsOverviewModel>(
