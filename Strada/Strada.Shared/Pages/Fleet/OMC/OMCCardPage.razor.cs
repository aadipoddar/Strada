...
public partial class OMCCardPage
{
	...
	private async Task DeleteRecoverSelectedItem()
	{
		...
		if (record.Status)
			await ShowConfirmation("Delete", $"Are you sure you want to delete {record.CardNumber}", () => DeleteTransaction(record.Id));
		else
			await ShowConfirmation("Recover", $"Are you sure you want to recover {record.CardNumber}", () => RecoverTransaction(record.Id));
	}
