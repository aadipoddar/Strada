...
public partial class OMCCardMoneyTransferReport : IAsyncDisposable
{
	...
	private List<OMCCardMoneyTransferOverviewModel> _transactionOverviews = [];
	private List<OMCCardMoneyTransferOverviewModel> _allTransactionOverviews = [];
	...
	private SfGrid<OMCCardMoneyTransferOverviewModel> _sfGrid;
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			_allTransactionOverviews = await CommonData.LoadTableDataByDate<OMCCardMoneyTransferOverviewModel>(
				FleetNames.OMCCardMoneyTransferOverview,
	...
	#region Utilities
	private async Task OnGridContextMenuItemClicked(ContextMenuClickEventArgs<OMCCardMoneyTransferOverviewModel> args)
	{
		switch (args.Item.Id)
		{
