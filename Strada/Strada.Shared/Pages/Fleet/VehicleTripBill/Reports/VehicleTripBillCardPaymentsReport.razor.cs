...
public partial class VehicleTripBillCardPaymentsReport : IAsyncDisposable
{
	...
	private List<VehicleTripBillCardPaymentsOverviewModel> _transactionOverviews = [];

	private SfGrid<VehicleTripBillCardPaymentsOverviewModel> _sfGrid;
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			_transactionOverviews = await CommonData.LoadTableDataByDate<VehicleTripBillCardPaymentsOverviewModel>(
				FleetNames.VehicleTripBillCardPaymentsOverview,
	...
	private async Task ExportExcel()
	{
		...
		try
		{
			...
			var (stream, fileName) = await VehicleTripBillReportExport.ExportCardPaymentsReport(
	...
	private async Task OnGridContextMenuItemClicked(ContextMenuClickEventArgs<VehicleTripBillCardPaymentsOverviewModel> args)
	{
		switch (args.Item.Id)
		{
			case "View":
