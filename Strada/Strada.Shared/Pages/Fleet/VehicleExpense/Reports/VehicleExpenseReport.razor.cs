...
namespace Strada.Shared.Pages.Fleet.VehicleExpense.Reports;
...
public partial class VehicleExpenseReport : IAsyncDisposable
{
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			_transactionOverviews = await CommonData.LoadTableDataByDate<VehicleExpenseOverviewModel>(
				FleetNames.VehicleExpenseOverview,
	...
	private async Task ConfirmDelete()
	{
		...
		try
		{
			...
			var expense = await CommonData.LoadTableDataById<VehicleExpenseModel>(FleetNames.VehicleExpense, _deleteTransactionId)
	...
	private async Task ConfirmRecover()
	{
		...
		try
		{
			...
			var expense = await CommonData.LoadTableDataById<VehicleExpenseModel>(FleetNames.VehicleExpense, _recoverTransactionId)
				?? throw new Exception("Transaction not found.");
			expense.Status = true;
			expense.LastModifiedBy = _user.Id;
			expense.LastModifiedAt = await CommonData.LoadCurrentDateTime();
