...
public partial class BillCardPaymentsReport : IAsyncDisposable
{
	...
	private List<BillCardPaymentsOverviewModel> _transactionOverviews = [];

	private SfGrid<BillCardPaymentsOverviewModel> _sfGrid;
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			_transactionOverviews = await CommonData.LoadTableDataByDate<BillCardPaymentsOverviewModel>(
				FleetNames.BillCardPaymentsOverview,
	...
	private async Task ExportExcel()
	{
		...
		try
		{
			...
			var (stream, fileName) = await BillReportExport.ExportCardPaymentsReport(
	...
	private async Task OnGridContextMenuItemClicked(ContextMenuClickEventArgs<BillCardPaymentsOverviewModel> args)
	{
		switch (args.Item.Id)
		{
			case "View":
