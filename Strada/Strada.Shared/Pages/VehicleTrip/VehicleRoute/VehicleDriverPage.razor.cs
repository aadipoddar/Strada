...
public partial class VehicleDriverPage
{
	...
	{
		_vehicleDrivers = await CommonData.LoadTableData<VehicleDriverModel>(VehicleTripNames.VehicleDriver);
	...
	private async Task ConfirmDelete()
	{
		try
		{
			...
			var vehicleDriver = await CommonData.LoadTableDataById<VehicleDriverModel>(VehicleTripNames.VehicleDriver, _deleteTransactionId)
	...
	private async Task ConfirmRecover()
	{
		try
		{
			...
			var vehicleDriver = await CommonData.LoadTableDataById<VehicleDriverModel>(VehicleTripNames.VehicleDriver, _recoverTransactionId)
				?? throw new Exception("Transaction not found.");
	...
	private async Task EditSelectedItem()
	{
		...
		_vehicleDriver = await CommonData.LoadTableDataById<VehicleDriverModel>(VehicleTripNames.VehicleDriver, selectedRecords[0].Id);
