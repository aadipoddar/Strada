...
public partial class VehicleRouteLocationPage
{
	...
	private async Task ConfirmDelete()
	{
		try
		{
			...
			var routeLocation = await CommonData.LoadTableDataById<VehicleRouteLocationModel>(VehicleTripNames.VehicleRouteLocation, _deleteTransactionId)
	...
	private async Task ConfirmRecover()
	{
		try
		{
			...
			var routeLocation = await CommonData.LoadTableDataById<VehicleRouteLocationModel>(VehicleTripNames.VehicleRouteLocation, _recoverTransactionId)
				?? throw new Exception("Transaction not found.");
	...
	private async Task EditSelectedItem()
	{
		...
		_routeLocation = await CommonData.LoadTableDataById<VehicleRouteLocationModel>(VehicleTripNames.VehicleRouteLocation, selectedRecords[0].Id);
