...
namespace Strada.Shared.Pages.VehicleTrip.VehicleRoute;
...
public partial class VehicleRoutePage
{
	...
	{
		_vehicleRoutes = await CommonData.LoadTableData<VehicleRouteModel>(VehicleTripNames.VehicleRoute);
		_routeLocations = await CommonData.LoadTableData<VehicleRouteLocationModel>(VehicleTripNames.VehicleRouteLocation);
	...
	private async Task ConfirmDelete()
	{
		try
		{
			...
			var vehicleRoute = await CommonData.LoadTableDataById<VehicleRouteModel>(VehicleTripNames.VehicleRoute, _deleteTransactionId)
	...
	private async Task ConfirmRecover()
	{
		try
		{
			...
			var vehicleRoute = await CommonData.LoadTableDataById<VehicleRouteModel>(VehicleTripNames.VehicleRoute, _recoverTransactionId)
				?? throw new Exception("Transaction not found.");
	...
	private async Task EditSelectedItem()
	{
		...
		_vehicleRoute = await CommonData.LoadTableDataById<VehicleRouteModel>(VehicleTripNames.VehicleRoute, selectedRecords[0].Id);
