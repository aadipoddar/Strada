...
public partial class TripAdvanceExpensesReport : IAsyncDisposable
{
	...
	private List<TripAdvanceExpensesOverviewModel> _transactionOverviews = [];

	private SfGrid<TripAdvanceExpensesOverviewModel> _sfGrid;
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			_transactionOverviews = await CommonData.LoadTableDataByDate<TripAdvanceExpensesOverviewModel>(
				VehicleTripNames.TripAdvanceExpensesOverview,
	...
	private async Task ExportExcel()
	{
		...
		try
		{
			...
			var (stream, fileName) = await TripAdvanceReportExport.ExportExpensesReport(
	...
	private async Task OnGridContextMenuItemClicked(ContextMenuClickEventArgs<TripAdvanceExpensesOverviewModel> args)
	{
		switch (args.Item.Id)
		{
			case "View":
