...
public partial class TripAdvancePaymentsReport : IAsyncDisposable
{
	...
	private List<TripAdvanceCardPaymentsOverviewModel> _transactionOverviews = [];

	private SfGrid<TripAdvanceCardPaymentsOverviewModel> _sfGrid;
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			_transactionOverviews = await CommonData.LoadTableDataByDate<TripAdvanceCardPaymentsOverviewModel>(
				VehicleTripNames.TripAdvanceCardPaymentsOverview,
	...
	private async Task ExportExcel()
	{
		...
		try
		{
			...
			var (stream, fileName) = await TripAdvanceReportExport.ExportPaymentsReport(
	...
	private async Task OnGridContextMenuItemClicked(ContextMenuClickEventArgs<TripAdvanceCardPaymentsOverviewModel> args)
	{
		switch (args.Item.Id)
		{
			case "View":
