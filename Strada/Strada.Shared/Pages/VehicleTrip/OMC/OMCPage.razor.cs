...
public partial class OMCPage
{
	...
	private async Task ConfirmDelete()
	{
		try
		{
			...
			var omc = await CommonData.LoadTableDataById<OMCModel>(VehicleTripNames.OMC, _deleteTransactionId)
	...
	private async Task ConfirmRecover()
	{
		try
		{
			...
			var omc = await CommonData.LoadTableDataById<OMCModel>(VehicleTripNames.OMC, _recoverTransactionId)
				?? throw new Exception("Transaction not found.");
	...
	private async Task EditSelectedItem()
	{
		...
		_omc = await CommonData.LoadTableDataById<OMCModel>(VehicleTripNames.OMC, selectedRecords[0].Id);
		if (_omc is null)
