...
public partial class VehicleExpenseTypePage
{
	...
	{
		_vehicleExpenseTypes = await CommonData.LoadTableData<VehicleExpenseTypeModel>(VehicleExpenseNames.VehicleExpenseType);
	...
	private async Task ConfirmDelete()
	{
		try
		{
			...
			var vehicleExpenseType = await CommonData.LoadTableDataById<VehicleExpenseTypeModel>(VehicleExpenseNames.VehicleExpenseType, _deleteTransactionId)
	...
	private async Task ConfirmRecover()
	{
		try
		{
			...
			var vehicleExpenseType = await CommonData.LoadTableDataById<VehicleExpenseTypeModel>(VehicleExpenseNames.VehicleExpenseType, _recoverTransactionId)
				?? throw new Exception("Transaction not found.");
	...
	private async Task EditSelectedItem()
	{
		...
		_vehicleExpenseType = await CommonData.LoadTableDataById<VehicleExpenseTypeModel>(VehicleExpenseNames.VehicleExpenseType, selectedRecords[0].Id);
