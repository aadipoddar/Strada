...
using StradaLibrary.Data.VehicleExpense;
...
namespace Strada.Shared.Pages.VehicleExpense.Reports;

public partial class VehicleExpenseReport : IAsyncDisposable
{
	...
	private List<VehicleExpenseOverviewModel> _transactionOverviews = [];
	...
	private SfGrid<VehicleExpenseOverviewModel> _sfGrid;
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			_transactionOverviews = await CommonData.LoadTableDataByDate<VehicleExpenseOverviewModel>(
				VehicleExpenseNames.VehicleExpenseOverview,
	...
	private async Task ExportExcel()
	{
		...
		try
		{
			...
			var (stream, fileName) = await VehicleExpenseReportExport.ExportReport(
	...
	private async Task ConfirmDelete()
	{
		...
		try
		{
			...
			var expense = await CommonData.LoadTableDataById<VehicleExpenseModel>(VehicleExpenseNames.VehicleExpense, _deleteTransactionId)
	...
	private async Task ConfirmRecover()
	{
		...
		try
		{
			...
			var expense = await CommonData.LoadTableDataById<VehicleExpenseModel>(VehicleExpenseNames.VehicleExpense, _recoverTransactionId)
				?? throw new Exception("Transaction not found.");
			expense.Status = true;
			expense.LastModifiedBy = _user.Id;
			expense.LastModifiedAt = await CommonData.LoadCurrentDateTime();
	...
	private async Task OnMenuSelected(Syncfusion.Blazor.Navigations.MenuEventArgs<Syncfusion.Blazor.Navigations.MenuItem> args)
	{
		...
		{
			case "NewTransaction":
				await AuthenticationService.NavigateToRoute(PageRouteNames.VehicleExpense, FormFactor, JSRuntime, NavigationManager);
				break;
			case "Refresh":
				await LoadTransactionOverviews();
				break;
	...
	private async Task OnGridContextMenuItemClicked(ContextMenuClickEventArgs<VehicleExpenseOverviewModel> args)
	{
		switch (args.Item.Id)
		{
			case "View":
