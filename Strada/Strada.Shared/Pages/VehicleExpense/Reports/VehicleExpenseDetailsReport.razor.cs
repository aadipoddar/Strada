...
public partial class VehicleExpenseDetailsReport : IAsyncDisposable
{
	...
	private List<VehicleExpenseDetailsOverviewModel> _transactionOverviews = [];

	private SfGrid<VehicleExpenseDetailsOverviewModel> _sfGrid;
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			_transactionOverviews = await CommonData.LoadTableDataByDate<VehicleExpenseDetailsOverviewModel>(
	...
	private async Task ExportExcel()
	{
		...
		try
		{
			...
			var (stream, fileName) = await VehicleExpenseReportExport.ExportDetailsReport(
	...
	private async Task OnGridContextMenuItemClicked(ContextMenuClickEventArgs<VehicleExpenseDetailsOverviewModel> args)
	{
		switch (args.Item.Id)
		{
			case "View":
