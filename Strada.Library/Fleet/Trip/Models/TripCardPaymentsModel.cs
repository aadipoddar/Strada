namespace Strada.Library.Fleet.Trip.Models;

public class TripCardPaymentsModel
{
...
public class TripCardPaymentsCartModel
{
	public int OMCCardId { get; set; }
...
public class TripCardPaymentsOverviewModel
{
	public int Id { get; set; }
	public int OMCCardId { get; set; }
	public string OMCCardNumber { get; set; }
